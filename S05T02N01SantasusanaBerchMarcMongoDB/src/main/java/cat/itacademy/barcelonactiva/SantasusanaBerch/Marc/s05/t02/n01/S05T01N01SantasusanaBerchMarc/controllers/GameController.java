...
public class GameController {
    ...
    public ResponseEntity<Game> play(@PathVariable(name = "id") String playerId)
    {
    ...
    public ResponseEntity<String> deletePlayerGames(@PathVariable(name = "id") String playerId)
    {
    ...
    public ResponseEntity<List<Game>> getAllPlayerGames(@PathVariable(name = "id") String playerId)
    {
    ...
    {
        String id = playerUpdateRequest.id();
